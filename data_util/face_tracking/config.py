...
cfg.deca_dir = "/sensei-fs/users/athar/Projects/DECA/"
cfg.device = "cuda"
cfg.device_id = "0"

cfg.pretrained_modelpath = os.path.join(
    "/sensei-fs/users/athar/Projects/DECA/", "checkpoints", "deca_model.tar"
)
...
cfg.model.flame_model_path = os.path.join(
    "/sensei-fs/users/athar/Projects/FLAME2020/", "generic_model.pkl"
)
...
def str_to_list(string, sep=","):
    string_no_spaces = string.replace(" ", "").lower()
    return string_no_spaces.split(",")
